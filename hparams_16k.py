...
wav_path = '/media/hdd2/dipjyoti/VCTK-Corpus/wavs_16'
data_path = 'data/'
...
voc_model_id = 'vctk_16k_mol'
tts_model_id = 'vctk_16k_lsa_smooth_attention'
...
# Training
voc_batch_size = 64 #**** original code, it is 32****** 
voc_lr = 1e-4
